                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-5 space-y-3 border border-gray-200 dark:border-gray-600 hover:shadow-md transition-shadow">
                    {emotion.frame_image && (
                      <div className="mb-3">
                        <img 
                          ...
                          className="w-full max-w-sm h-auto rounded-lg border-2 border-gray-300 dark:border-gray-600 shadow-sm"
                        />
                      </div>
                    )}
                    ...
                    {emotion.all_emotions && (
                      <div className="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                        <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">All Detected Emotions:</div>
                              ...
                              <div key={emotionName} className="space-y-1">
                                <div className="flex items-center justify-between">
                                  <span className="text-sm font-medium text-gray-700 dark:text-gray-200 flex items-center gap-1">
                                    <span className="text-lg">{getEmotionEmoji(emotionName)}</span>
